...
<html lang="">
	<head>
	<?php //VIEW INI GADIPAKEE, Cuma Buat Nyoba"?>
		<meta charset="utf-8">
		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<a href="<?php echo site_url('pegawai/create') ?>" type="button" class="btn btn-default">Tambah Data Pegawai</a>	
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" onclick = "return confirm()" class="btn btn-danger">Delete</a>
